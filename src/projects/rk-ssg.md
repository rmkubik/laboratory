...
- [Ryan Kubik's Static Site Generator](https://github.com/rmkubik/rk-ssg)
...
I'd like to replace the Next.js site that I run on my personal site, [ryankubik.com](https://ryankubik.com/). It's okay for blog posts, but it feels overcomplicated to me now. It is also frustrating to try and put anything non-React into my site. I'm not sure when I'll get around to migrating everything over.
